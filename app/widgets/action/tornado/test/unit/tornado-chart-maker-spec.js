...
describe("Tornado Chart Maker Tests", function () {
    ...
    beforeEach(function () {
        ...
        var shadowNodeName = "Shadow Node";
        var nodeName = "Node";
        var maxBars = 10;
    ...
    describe("Metalog", function () {
        ...
        describe("initialize", function () {
            ...
            it("should create fitted points array", function () {
                ...
                expect(fittedPoints[0]).toEqual([0.7267024750731296, 0.015625]);
...
var TornadoChartDataForTesting = (function () {
    function TornadoChartDataForTesting() {
    }
    TornadoChartDataForTesting.prototype.inputData = function () {
        return {
    ...
    TornadoChartDataForTesting.prototype.shadowInputData = function () {
        return {
            "CombinedUncertaintyLabel": "Combined Uncertainty Range",
    ...
    return TornadoChartDataForTesting;
}());
//# sourceMappingURL=tornado-chart-maker-spec.js.map